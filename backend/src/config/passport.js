...
// Warn if OAuth credentials are not set
if (!process.env.GOOGLE_CLIENT_ID || !process.env.GOOGLE_CLIENT_SECRET) {
  console.warn('⚠️ WARNING: Google OAuth environment variables are missing. Google Login will not function correctly.');
}
if (!process.env.GITHUB_CLIENT_ID || !process.env.GITHUB_CLIENT_SECRET) {
  console.warn('⚠️ WARNING: GitHub OAuth environment variables are missing. GitHub Login will not function correctly.');
}
