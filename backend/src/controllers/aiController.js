const { analyzeResume, conductMockInterview, generateBio } = require('../services/aiService');
...
const handleGenerateBio = async (req, res) => {
  try {
    const { role, skills, experience, niche } = req.body;
    const bio = await generateBio({ role, skills, experience, niche });
...
module.exports = { scoreResume, handleInterviewChat, handleGenerateBio };
