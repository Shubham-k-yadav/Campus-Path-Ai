...
export default function Login() {
  ...
  return (
    <div className={`min-h-screen ${colors.bg} ${colors.text} relative flex items-center justify-center p-4 overflow-hidden transition-colors duration-300`}>
      ...
      >
        ...
        <p className="text-center mt-6 text-muted-foreground font-semibold text-sm">
          ...
          <Link to="/register" className="text-[#4285F4] dark:text-[#4285F4] font-extrabold hover:underline underline-offset-4">Create one free</Link>
        </p>
      </motion.div>
    </div>
  );
