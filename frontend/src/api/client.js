...
export const authAPI = {
  ...
  getPublicPortfolio: (userId) => api.get(`/auth/portfolio/${userId}`),
};
...
export const communityAPI = {
  getPosts: (page = 1) => api.get(`/community/posts?page=${page}&limit=20`),
  createPost: (data) => api.post('/community/posts', data),
  toggleUpvote: (id) => api.post(`/community/posts/${id}/upvote`),
